...
const RetrieveHumanoidFilled = React.forwardRef<HTMLSpanElement, SensoroIconProps>((props, ref) => (
  <SensoroIcon {...props} ref={ref} icon={RetrieveHumanoidFilledSvg} />
));

RetrieveHumanoidFilled.displayName = 'RetrieveHumanoidFilled';

export default RetrieveHumanoidFilled;
